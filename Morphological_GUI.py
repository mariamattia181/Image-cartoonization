...
def edge_detection(image, line_thickness):
    ...
    ksize = max(3, (line_thickness // 2) * 2 + 1) 
    ...
    def cartoonize(self):
        if self.image_path:
            ...
            cartoon_image = cartoonize_image(
                self.original_image, num_colors=num_colors, line_thickness=line_thickness,
                saturation=saturation, intensity=intensity, use_cartoon_palette=use_cartoon_palette
            )
